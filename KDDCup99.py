...
os.environ['SPARK_HOME']="/home/serv/spark-2.0.0-bin-hadoop2.7"

# Append pyspark  to Python Path
sys.path.append("/home/serv/spark-2.0.0-bin-hadoop2.7/python/")
...
if __name__ == "__main__":
    if (len(sys.argv) != 3):
        print "Usage: /home/serv/spark-2.0.0-bin-hadoop2.7/bin/spark-submit --driver-memory 2g " + \
